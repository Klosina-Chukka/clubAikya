...
class _ClubDetailPageState extends State<ClubDetailPage> {
  ...
  Future<void> fetchEvents() async {
    final url = Uri.parse(
        'https://4274-2405-201-c42a-4810-30a2-fb9e-81e0-e319.ngrok-free.app/api/clubs/${widget.clubName}/events');
    try {
...
Future<void> fetchRole() async {
  try {
    ...
    final url = Uri.parse(
        'https://4274-2405-201-c42a-4810-30a2-fb9e-81e0-e319.ngrok-free.app/profile');
